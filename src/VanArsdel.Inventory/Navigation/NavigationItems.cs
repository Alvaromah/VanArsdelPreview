...
namespace VanArsdel.Inventory
{
    static public class KnownNavigationItems
    {
        ...
        static public readonly NavigationItem CustomerOrders = new NavigationItem(0xE136, "Customer Orders", typeof(CustomerOrdersView));
        static public readonly NavigationItem Orders = new NavigationItem(0xE14C, "Orders", typeof(OrdersView));
        static public readonly NavigationItem Categories = new NavigationItem(0xE8EC, "Categories", typeof(CommonView));
